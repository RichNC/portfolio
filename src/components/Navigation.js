  ...
  return (
    <div className="navigation">
      ...
      <div className="navigation-sub">
        ...
        <a className="item" target="_blank" rel="noopener noreferrer" href="https://github.com/rich-cherry"><i class="fab fa-github"></i></a>
        <a className="item" target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/rich-cherry/"><i class="fab fa-linkedin"></i></a>
      </div>
    </div>
  )
}
